...
public class BlurImageHandler extends ImageProcessingHandler {
    ...
    public BlurImageHandler(MetricsWriter metricsWriter) {
        super(metricsWriter);
    }
    ...
    public static void main(String[] args) {
        ...
        BufferedImage bufferedOutput = new BlurImageHandler(metricsWriter).process(bufferedInput);
        UtilImageIO.saveImage(bufferedOutput, outputImagePath);
    }

    @Override
    public String getName() {
        return new String("blurimage");
    }
}
